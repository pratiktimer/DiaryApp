...
import com.prateektimer.diaryapp.presentation.components.DiaryHolder
...
fun DateHeader(localDate: LocalDate){
    Row(
        modifier = Modifier.background(MaterialTheme.colorScheme.surface).padding(14.dp).fillMaxWidth(),
